...
export class TrzszTransfer {
  ...
  private async sendFileNum(num: number, progressCallback: ProgressCallback | null) {
  ...
  private async sendFileName(file: TrzszFileReader, directory: boolean, progressCallback: ProgressCallback | null) {
  ...
  private async sendFileSize(size: number, progressCallback: ProgressCallback | null) {
  ...
  private async sendFileMD5(digest: Uint8Array, progressCallback: ProgressCallback | null) {
  ...
  private async recvFileNum(progressCallback: ProgressCallback | null) {
  ...
  private async recvFileSize(progressCallback: ProgressCallback | null) {
  ...
  private async recvFileMD5(digest: Uint8Array, progressCallback: ProgressCallback | null) {
